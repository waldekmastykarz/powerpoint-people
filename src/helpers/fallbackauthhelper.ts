...
import { showPeoplePicker, writeDataToOfficeDocument } from "./../taskpane/taskpane";
import { setAccessToken } from "./ssoauthhelper";
var loginDialog;
...
async function processMessage(arg) {
  ...
  if (messageFromDialog.status === "success") {
    ...
    loginDialog.close();
    setAccessToken(messageFromDialog.result);
    showPeoplePicker();
    ...
    loginDialog.close();
    sso.showMessage(messageFromDialog.result.errorMessage);
  }
}
